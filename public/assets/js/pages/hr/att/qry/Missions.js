let phQForm;
let  aType = PhSettings.UsrCodes.EmpMission,
...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Emp/Missions';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('Missions', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'msnDdate', componentType: PhFC_DatePicker,
          ...
          field: 'msnNum', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          ...
          field: 'msnSdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['01-01-2023', ''],
          aOpers: aDOpers
        }, {
          ...
          field: 'msnEdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['01-01-2023', ''],
          aOpers: aDOpers
        }, {
          ...
          field: 'msnShour', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
          ...
          field: 'msnEhour', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
