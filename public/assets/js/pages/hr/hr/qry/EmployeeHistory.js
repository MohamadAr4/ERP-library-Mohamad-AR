...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Emp/EmploeeHistory';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('EmployeeHistory', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'histDdate', componentType: PhFC_DatePicker,
          ...
          field: 'histNum', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          ...
          label: 'Description', labelCol: 3,
          element: 'fldNote', elementCol: 9,
          field: 'histNote', componentType: PhFC_Text,
          isRequired: false, hasSecondField: false,
          defValue: [''],
          aOpers: aTAOpers
        }, {
