...
let meta = {
  ...
  URLS: {
    New: { URl: `${BaseUrl}UC/Emp/AdminConsiderationMst/New`, Method: "POST" },
    Update: { URl: `${BaseUrl}UC/Emp/AdminConsiderationMst/`, Method: "PUT" },
    Delete: { URl: `${BaseUrl}UC/Emp/AdminConsiderationMst/`, Method: "DELETE" },
    Search: { URl: `${BaseUrl}UC/Emp/AdminConsiderationMst/Search/`, Method: "POST" },
    Get: { URl: `${BaseUrl}UC/Emp/AdminConsiderationMst/`, Method: "GET" },
  },
  Fields: [
    {
      label: "Number",
