...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Fix/ResponsibilityStatistics';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Statistics'};
  phQForm = new PhQForm('ResponsibilityStatistics', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: {
        ...
        defValue: ['fixdNum', 'fixdName', -1, -1, -1, -1, -1, -1, -1, -1, -1]
      }}};
  return card;
}
