let phQForm;
let aType = PhSettings.UsrCodes.EmpConsideration,
...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Emp/AdminConsideration';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('ADMConsideration', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'ddate', componentType: PhFC_DatePicker,
          ...
          field: 'consId', componentType: PhFC_Select,
          isRequired: false, hasSecondField: false,
          ...
          field: 'trnPoints', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
          ...
          field: 'trnDays', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
