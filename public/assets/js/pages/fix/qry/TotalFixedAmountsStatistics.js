...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Fix/TotalFixedAmounts';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Statistics'};
  phQForm = new PhQForm('TotalFixedAmountsStatistics', options);
...
function initAggregation() {
  ...
  aAggregation[nIdx++] = {
    ...
    "Aggrs": [PhAggregate_Sum, PhAggregate_Avg]
  };
  aAggregation[nIdx++] = {
    "id": "1",
    "filed": "trnAmt",
  ...
  let card = {
    ...
    body: {
      ...
      fields: {
        ...
        isRequired: true, aggregationCount: 1,
        options: aAggregation, defValue: ['totFamtDeprication']
      }}};
  return card;
}
