...
let  aCity = PhSettings.UsrCodes.LrgCity,
     ...
     aLawyer = [],
     aArbitClaus = PhSettings.UsrCodes.LrgCodeArbitrationClause,
...
jQuery(document).ready(function () {       
  ...
  phForm = new PhForm('ArbitrationSuits', metta, options);
...
function getQFields() {
  ...
  aQFields[idx++] = {
    label: getLabel('ArbitClausId'),
    element: 'ArbitClausId',
    field: 'arbitclausId',
    component: PhFC_Select,
    defValue: '',
    options: aArbitClaus,
...
function getFields() {
  ...
  aFields[idx++] = {
    label: getLabel('ArbitClausId'),
    element: 'fldArbitClausId',
    field: 'arbitclausId',
    rField: 'arbitclausName',
    getLabel: true,
    isRequired: true,
    defValue: '',
    options: aArbitClaus,
