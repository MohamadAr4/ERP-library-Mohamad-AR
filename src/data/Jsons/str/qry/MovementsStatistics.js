...
import { PhFC_DatePicker, PhFC_Number, PhFC_Select, PhFC_Text } from "../../../operation";
...
let aGroup = [
  ...
  { id: "dYear", name: "Year" },
  { id: "dMonth", name: "Month" },
  { id: "dDayOfMonth", name: "Day Of Month" },
  { id: "dDayOfYear", name: "Day Of Year" },
  { id: "dDayOfWeek", name: "Day Of Week" },
  { id: "dYearMonth", name: "Year Month" },
];
...
let meta = {
  ...
  URLS: {
    ...
    Search: {
      URl: "http://localhost:9090/phs/api/UC/Str/TransactionsStatistics/Statistics",
      Method: "POST",
    },
    Get: { URl: "", Method: "GET" },
  },
