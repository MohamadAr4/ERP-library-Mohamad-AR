...
let meta = {
  ...
  URLS: {
    New: {
      URl: `${BaseUrl}UC/Emp/LeaveRequest/New`,
      Method: "POST",
    },
    Update: {
      URl: `${BaseUrl}UC/Emp/LeaveRequest/`,
      Method: "PUT",
    },
    Delete: {
      URl: `${BaseUrl}UC/Emp/LeaveRequest/`,
    ...
    Search: {
      URl: `${BaseUrl}UC/Emp/LeaveRequest/Search/`,
      Method: "POST",
    },
    Get: {
  ...
  Fields: [
    ...
    },
    {
      ...
      Query: {
        ...
        dataType: PhFC_Select,
        Operation: "statusi", //must be unique
