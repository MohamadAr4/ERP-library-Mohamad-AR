...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Emp/Leaves';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('Leaves', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'leaveNum', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          ...
          field: 'leaveSdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['01-01-2023', ''],
          aOpers: aDOpers
        }, {
          ...
          field: 'leaveEdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['01-01-2023', ''],
          aOpers: aDOpers
        }, {
          ...
          field: 'leaveShour', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
          ...
          field: 'leaveEhour', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
