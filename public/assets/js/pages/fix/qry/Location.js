...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Fix/Location';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('Location', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'nloc1Id', componentType: PhFC_Select,
          isRequired: false, hasSecondField: false,
          defValue: [1], options: aLocation1,
          aOpers: aSAOpers
        }, {
          label: 'Location.2', labelCol: 3,
          element: 'nloc2Id', elementCol: 9,
          field: 'nloc2Id', componentType: PhFC_Select,
          isRequired: false, hasSecondField: false,
          ...
          field: 'nloc3Id', componentType: PhFC_Select,
          isRequired: false, hasSecondField: false,
          defValue: [1], options: aLocation1,
          aOpers: aSAOpers
        }, {
          ...
          field: 'trnIspc6', componentType: PhFC_Text,
          isRequired: false, hasSecondField: false,
          defValue: [''],
          aOpers: aTOpers
        }
...
function displayOption() {
  let card = {
    ...
    body: {
      fields: [
        {col: 3,
          label: 'Old.Loc.1', labelCol: 9,
          element: 'disOLoc1', elementCol: 2,
          field: 'oloc1Name', componentType: PhFC_CheckBox,
          defValue: 0
        }, {col: 3,
          label: 'Old.Loc.2', labelCol: 9,
          element: 'disOLoc2', elementCol: 2,
          field: 'oloc2Name', componentType: PhFC_CheckBox,
          defValue: 0
        }, {col: 6,
          label: 'Old.Loc.3', labelCol: 9,
          element: 'disOLoc3', elementCol: 1,
          field: 'oloc3Name', componentType: PhFC_CheckBox,
          defValue: 0
        }, {col: 3,
