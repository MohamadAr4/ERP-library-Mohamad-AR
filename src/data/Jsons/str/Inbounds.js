...
let meta = {
  ...
  URLS: {
    New:    { URl: `${BaseUrl}UC/Str/InputMaster/New`, Method: "POST" },
    Update: { URl: `${BaseUrl}UC/Str/InputMaster/`, Method: "PUT" },
    Delete: { URl: `${BaseUrl}UC/Str/InputMaster/`, Method: "DELETE" },
    Search: { URl: `${BaseUrl}UC/Str/InputMaster/Search/`, Method: "POST" },
    Get:    { URl: `${BaseUrl}UC/Str/InputMaster/`, Method: "GET" },
  },
  Fields: [
    {
      label: "Number",
