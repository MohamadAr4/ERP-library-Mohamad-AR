...
let aGroup = [
  ...
  {id: 'spc1Id', name: getLabel('Specification.1')},
  {id: 'spc2Id', name: getLabel('Specification.2')},
  {id: 'spc3Id', name: getLabel('Specification.3')},
  {id: 'spc4Id', name: getLabel('Specification.4')},
  {id: 'spc5Id', name: getLabel('Specification.5')}];
...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/CC/Str/InventoryComparison';
  options.aUrl.RUrl = {Method: 'POST', URL: ''};
  phQForm = new PhQForm('CompareMovementsPeriods', options);
});
  ...
  let card = {
    ...
    body: {
      ...
      fields: {
        ...
        element: 'Grp', elementCol: 9,
        field: 'grp', componentType: PhFC_Select,
        isRequired: false, groupCount: 7,
        defValue: ['storName', -1, -1, -1, -1, -1, -1], options: aGroup
      }}};
  return card;
}
