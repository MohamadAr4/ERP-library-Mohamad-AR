...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Emp/AppraisalNotes';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('AppraisalNote', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'noteDdate', componentType: PhFC_DatePicker,
          ...
          field: 'noteNum', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
          ...
          label: 'Appraisal.Note', labelCol: 3,
          element: 'fldRem', elementCol: 9,
          field: 'noteRem', componentType: PhFC_Text,
          isRequired: false, hasSecondField: false,
          defValue: [''],
          aOpers: aTAOpers
        }, {
          ...
          field: 'notePoints', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
