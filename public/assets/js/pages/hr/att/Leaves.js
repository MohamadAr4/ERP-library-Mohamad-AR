...
jQuery(document).ready(function () {
  ...
  phForm = new PhForm('Leaves', metta, options);
...
function checkType() {
  $('#fldTypeId').on('change', function () {
    if ($('#fldTypeId').val() === "310" || $('#fldTypeId').val() === "210" || $('#fldTypeId').val() === "200" || $('#fldTypeId').val() === "325" || $('#fldTypeId').val() === "350" || $('#fldTypeId').val() === "520" ) {
