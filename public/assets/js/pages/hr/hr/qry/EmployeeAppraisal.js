...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Emp/AppraisalEmployee';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('EmployeeAppraisal', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'eapprDdate', componentType: PhFC_DatePicker,
          ...
          field: 'eapprNum', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
          ...
          label: 'eapprPoints', labelCol: 3,
          element: 'fldPoints', elementCol: 9,
          field: 'eapprPoints', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
          ...
          field: 'itmId', componentType: PhFC_Select,
          isRequired: false, hasSecondField: false,
          defValue: [-1], options: aApprItem,
          aOpers: aSAOpers
        }, {
          label: 'T.Date', labelCol: 3,
          element: 'fldTdate', elementCol: 9,
          field: 'eapprTdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aDOpers
        }, {
          label: 'F.Date', labelCol: 3,
          element: 'fldFdate', elementCol: 9,
          field: 'eapprFdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aDOpers
        }, {
...
function displayOption() {
  let card = {
    ...
    body: {
      fields: [{
          col: 3,
          label: 'Appraisal.Temp', labelCol: 8,
          element: 'Tmplt_Name', elementCol: 3,
          field: 'tmpltName', componentType: PhFC_CheckBox,
          ...
          col: 3,
          label: 'EapprRem', labelCol: 8,
          element: 'diseappRem', elementCol: 3,
          field: 'eapprRem', componentType: PhFC_CheckBox,
          isRequired: false, defValue: 0
        }, {
          col: 3,
          label: 'Description', labelCol: 8,
          element: 'diseapprTrem', elementCol: 3,
          field: 'eapprTrem', componentType: PhFC_CheckBox,
          isRequired: false, defValue: 0
        }
      ]
    }
