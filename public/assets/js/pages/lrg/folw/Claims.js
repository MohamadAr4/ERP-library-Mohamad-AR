let phForm;
let aStatus = PhSettings.UsrCodes.LrgClaimStatus,
        aRequest = [];
...
jQuery(document).ready(function () {
  ...
  aURL.Api = '/UC/Lrg/ReqFinancialClaim';
  ...
  phForm = new PhForm('Claims', metta, options);
});
