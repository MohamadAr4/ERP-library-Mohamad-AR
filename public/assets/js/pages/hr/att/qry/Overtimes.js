...
jQuery(document).ready(function () {
  ...
  options.aUrl.Api = '/UC/Emp/Overtimes';
  options.aUrl.RUrl = {Method: 'POST', URL: '/Query'};
  phQForm = new PhQForm('Overtimes', options);
  ...
  let card = {
    ...
    body: {
      ...
      fields: [{
          ...
          field: 'otimDdate', componentType: PhFC_DatePicker,
          ...
          field: 'otimNum', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          ...
          field: 'otimSdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['01-01-2023', ''],
          aOpers: aDOpers
        }, {
          ...
          field: 'otimEdate', componentType: PhFC_DatePicker,
          isRequired: false, hasSecondField: true,
          defValue: ['01-01-2023', ''],
          aOpers: aDOpers
        }, {
          ...
          field: 'otimShour', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
          ...
          field: 'otimEhour', componentType: PhFC_Number,
          isRequired: false, hasSecondField: true,
          defValue: ['', ''],
          aOpers: aNQOpers
        }, {
